...
SWIFT_MODULE_NAMESPACE_PUSH("Shop_Hosting")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC12Shop_Hosting11AppDelegate")
...
@interface UINavigationBar (SWIFT_EXTENSION(Shop_Hosting))
...
SWIFT_CLASS("_TtC12Shop_Hosting14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified emailIconImage;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified againPasswordImage;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified numberImage;
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified passwordAgainTextField;
...
SWIFT_CLASS("_TtC12Shop_Hosting20addItemTableViewCell")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified itemCostTextField;
...
SWIFT_CLASS("_TtC12Shop_Hosting29createShopTableViewController")
@interface createShopTableViewController : UITableViewController
- (void)viewDidLoad;
- (IBAction)cancelButton:(id _Nonnull)sender;
- (IBAction)createShop:(UIBarButtonItem * _Nonnull)sender;
...
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified deliveryAddressTextField;
...
SWIFT_CLASS("_TtC12Shop_Hosting24loggingOutViewController")
@interface loggingOutViewController : UIViewController
...
SWIFT_CLASS("_TtC12Shop_Hosting19loginViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified passwordLogin;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12Shop_Hosting21newItemViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified referralTextField;
- (IBAction)enterRefferalButton:(UIButton * _Nonnull)sender;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified referralStatusLabel;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12Shop_Hosting21shopListTableViewCell")
...
- (void)viewDidAppear:(BOOL)animated;
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified menuButton;
- (IBAction)addShopSegue:(id _Nonnull)sender;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC12Shop_Hosting27shopTitleTableTableViewCell")
@interface shopTitleTableTableViewCell : UITableViewCell
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
...
SWIFT_CLASS("_TtC12Shop_Hosting22storeItemTableViewCell")
...
- (IBAction)plusItem:(UIButton * _Nonnull)sender;
...
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (IBAction)markDeliveredBarButton:(UIBarButtonItem * _Nonnull)sender;
- (nonnull instancetype)initWithStyle:(UITableViewStyle)style OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
